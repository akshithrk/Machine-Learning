...
#############
# redcap api execution request for R
#############
...
library(RCurl)
result <- postForm(
  uri='https://redcap-qi.tch.harvard.edu/redcap_edc/api/',
  token='68C69E80B359A674732178FA033CAAE2',
  content='project',
  format='json',
  returnFormat='json'
)
...
RAW.API <- postForm('https://redcap-qi.tch.harvard.edu/redcap_edc/api/', token='68C69E80B359A674732178FA033CAAE2', content='project', 
